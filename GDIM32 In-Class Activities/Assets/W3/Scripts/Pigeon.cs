...
public class Pigeon : MonoBehaviour
{
    ...
    {
        if (Input.GetKey(KeyCode.A)) { _currentactiviy = MovementState.Flying;
         } else { _currentactiviy = MovementState.Idle; }
    }
